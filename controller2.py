...
for i in range (0,1):#NumberOfGroups):
    ...
    for j in range(0,3):#GA_Iterations):#some code to keep track of the best individual!!!!
        ...
        #tmpCollection = genetic_algo.evolve(tmpCollection, rule_choices, result.values, 0.7, 0.01)
