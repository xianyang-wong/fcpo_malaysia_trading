...
floglic.PlotGraph(1, 200, 10, True)
floglic.PlotGraph(1, 200, 10,False)
print (floglic.ComputeMembership(-20.5,200,10,1,1)) # value, m, n, MA_Type, bucket
print (floglic.ComputeMembership(-20.5,200,10,1,1,True))
