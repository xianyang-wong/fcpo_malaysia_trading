...
# =============================================================================
            ...
            for IndividualCount in range(0,20):           
                ...
                TmpDfFitness.iloc[IndividualCount]['profit'] = HoldingDiff*(index)
...
#                 tmpProfit.iloc[IndividualCount]['profit'] += 25 *self.DfFitness.iloc[IndividualCount]['holding'] * (df.High[self.EndIndex]  - self.DfFitness.iloc[IndividualCount]['lastTradeValue'])
        #print(((self.DfFitness.profit + self.DfFitness.riskfree - self.DfFitness.cost  )/self.DfFitness.capital).sort_values(ascending=True))
# =============================================================================
        print(self.DfFitness.sort_values(by=['profit'])['profit'])
